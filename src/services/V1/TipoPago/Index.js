...
export const getAllAsync = () => {
	...
	// 	},
	// };
	const URL = `${BASE_URL}/V1/TipoPagos/GetAll/${empresa}`;
...
export const getByIdAsync = (id) => {
	...
	const URL = `${BASE_URL}/V1/TipoPagos/GetById/${empresa}/${id}`;
...
export const CreateAsync = (json) => {
	...
	const URL = `${BASE_URL}/V1/TipoPagos/Create/${empresa}`;
...
export const EditAsync = (json, code) => {
	...
	const URL = `${BASE_URL}/V1/TipoPagos/Edit/${empresa}/${code}`;
...
export const DeleteAsync = (code) => {
	...
	const URL = `${BASE_URL}/V1/TipoPagos/Delete/${empresa}/${code}`;
