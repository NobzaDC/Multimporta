...
import { ACTIVE, CIUDADES_PATH, CONDICION_PAGO_PATH, ORDEN_COMPRA_PATH, PRESENTACION_PRODUCTO_PATH, PRODUCTO_PATH, PROVEEDOR_PATH, PUERTO_PATH, TERMINO_NEGOCIACION_PATH, TIPO_PAGO_PATH, USUARIO_PATH } from "helpers/const/Index";
	...
	return (
		<StyledSideBarBody>
			<BodyOptions isactive={active}>
				...
				<OpLink active={active} path={getServerPath(ORDEN_COMPRA_PATH.index)} name='Orden de compra' icon='fa-ballot-check'/>
			</BodyOptions>
		</StyledSideBarBody>
	);
};
